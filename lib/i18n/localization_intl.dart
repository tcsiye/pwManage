...
class GmLocalizations {
  ...
  String get formTitle => Intl.message('formTitle', name: 'formTitle');
  String get formAccount => Intl.message('formAccount', name: 'formAccount');
  String get formRemark => Intl.message('remark', name: 'remark');
  String get updateTime => Intl.message('updateTime', name: 'updateTime');
  String get createTime => Intl.message('createTime', name: 'createTime');
  String get last => Intl.message('last', name: 'last');
}
